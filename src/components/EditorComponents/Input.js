  ...
  return (
    <div className="flex flex-col w-[100%] h-[100%]">
      <div className="text-white h-10 flex items-center justify-around">
        <div className="h-10 rounded-lg w-40 max-[1140px]:h-8 max-[1140px]:w-8 max-[992px]:h-6 max-[992px]:w-6 max-[992px]:rounded-md max-[502px]:h-4 max-[502px]:w-4 max-[502px]:rounded-sm  border-2 border-white text-center p-1.5">Hello World</div>
        <Skeleton
          variant="text"
